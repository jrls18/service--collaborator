...
VALUES('ATIVO', now())
     ...
     ,('EMAIL ENVIADO AGUARDANDO CONFIGURACAO DE MENU',now())
     ,('MENU CONFIGURADO E FALHA NA ENVIO DE EMAIL DE ATIVACAO',now())
     ,('MENU CONFIGURADO E EMAIL DE VALIDACAO ENVIADO',now())
     ,('AGUARDANDO CONFIGURACAO DE MENU E FALHA NO ENVIO DE EMAIL',now());
