...
public final class FieldDomainConstants {

    private FieldDomainConstants(){
    }
    ...
    public static final String CODEMPRESA = "codigo_empresa";
    ...
    public static final String SIGLA_APP = "silga_app";
