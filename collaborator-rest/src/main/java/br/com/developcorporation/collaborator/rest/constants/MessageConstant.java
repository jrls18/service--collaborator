package br.com.developcorporation.collaborator.rest.constants;
...
public final class MessageConstant {
    ...
    public static final String FALHA_NA_VALIDACAO = "Falha na validação.";
    ...
    public static final String CODIGO_E_OBRIGATORIO = "Código é obrigatório.";

    public static final String INFORME_A_CHAVE_DE_ACESSO_CLIENT_ID = "Informe a chave de acesso client_id";
    public static final String INFORME_A_CHAVE_DE_ACESSO_CLIENT_SECRET = "Informe a chave de acesso client_secret";
